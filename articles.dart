...
class NewsService{ //비즈니스 클래스 
  ...
  Future<List<Article>> fetchArticles({int page = 1, String country='kr', String category='', String apiKey='65c81411210440abb26c46fd08e1a6f4'}) async{ 
    ...
    if(response.statusCode==200){ //성공적으로 응답을 받으면 
      ...
      for(var item in body){
        if (await _isUrlValid(item['urlToImage'])){ // item['urlToImage]가 참일 경우에만 리스트에 추가 
